...
import { CreateInvoiceComponent } from './routes/invoice/create-invoice/create-invoice.component';
...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'dashboard', component: CreateInvoiceComponent },
      ...
      {
        path: 'usuarios',
        loadChildren: () => import('./routes/user/user.routes').then(m => m.userRoutes),
      },
    ],
  },
  {
